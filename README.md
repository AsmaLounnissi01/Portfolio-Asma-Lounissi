...
- Python : Pandas, NumPy, Matplotlib, NLP, automatisation
- Data Quality : audit de données, détection d’anomalies, doublons, données manquantes
- Cloud & ETL : Azure Data Factory, Data Lake, Docker
...
[Voir le projet](./qualite-donnees)
...
- Mobilité : nationale
- LinkedIn : [asma-lounissi](https://www.linkedin.com/in/asma-lounissi)
